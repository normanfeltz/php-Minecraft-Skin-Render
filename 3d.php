...
class render3DPlayer
{
    ...
    /*
     * Function converts a 1.8 skin (which is not supported by the script) to the old skin format.
     * 
     * Espects an image.
    ...
    /* Function copys the extra layers of a 1.8 skin onto the base layers so that it will still show. QUICK FIX, NEEDS BETTER FIX
     *
     * Espects an image.
     * Returns a croped image.
     */
